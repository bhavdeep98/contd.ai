...
class ExecutionEngine:
    ...
    def acquire_lease(self, workflow_id: str, owner_id: str, org_id: str = "default") -> Optional[Lease]:
        """
    ...
    def complete_workflow(self, workflow_id: str, state: WorkflowState, last_event_seq: int):
        """
