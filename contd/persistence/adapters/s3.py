    ...
    def get(self, key: str, expected_checksum: str = None) -> str:
        ...
        try:
            ...
            if stored_checksum and actual_checksum != stored_checksum:
                raise IntegrityError(f"Checksum mismatch for {key}: stored={stored_checksum}, actual={actual_checksum}")
            
            if expected_checksum and actual_checksum != expected_checksum:
                raise IntegrityError(f"Checksum mismatch for {key}: expected={expected_checksum}, actual={actual_checksum}")
