...
class PostgresAdapter:
    ...
    def initialize(self):
        ...
        logger.info(f"Postgres pool initialized: {self.config.host}:{self.config.port}/{self.config.database}")
    ...
    def execute_with_wal_sync(self, query: str, *args) -> Any:
        ...
        with self.connection() as conn:
            ...
            try:
                ...
                cur.execute(f"SET synchronous_commit = '{self.config.synchronous_commit}'")
                cur.execute(query, args)
