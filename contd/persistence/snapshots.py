...
class SnapshotStore:
    ...
    def _save_to_s3(
        ...
        self.s3.put(s3_key, serialized, metadata={
    ...
    def get_at_seq(self, workflow_id: str, org_id: str, target_seq: int) -> Tuple[Optional[WorkflowState], int]:
        """
    ...
    def _cleanup_old_snapshots(self, workflow_id: str, org_id: str):
        ...
        for row in (old_snapshots or []):
            ...
            self.db.execute("DELETE FROM snapshots WHERE snapshot_id = ?", r['snapshot_id'])
