...
from contd.models.events import (
    StepIntentionEvent, StepCompletedEvent, StepFailedEvent, EventType
)
...
class StepExecutor:
    ...
    def execute_step(
        ...
        intention_seq = self._record_intention(
            workflow_id, org_id, step_id, step_name, attempt_id
        )
        ...
        try:
            ...
            self._record_failure(
                workflow_id, org_id, step_id, attempt_id, str(e)
            )
        ...
        try:
            ...
            for step_name, step_fn in steps:
                state, last_seq = self.step_executor.execute_step(
                    workflow_id, org_id, step_name, step_fn,
                    state, lease, last_seq
                )
