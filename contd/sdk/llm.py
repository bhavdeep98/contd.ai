...
class TokenTracker:
    ...
    def check_budget(self, workflow_id: str):
        ...
        """
        if self.workflow_token_budget and self.total_tokens > self.workflow_token_budget:
        ...
        if self.workflow_cost_budget and self.total_cost_dollars > self.workflow_cost_budget:
            raise TokenBudgetExceeded(
                workflow_id=workflow_id,
                budget_type="cost",
